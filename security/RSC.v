...
Section RSC.
  ...
  Proof.
    ...
    destruct (@transf_link _ _ _ _ _ (pass_match_link (compose_passes CompCert's_passes))
                p' Cs p'_compiled Cs_compiled Wbt link_bt
                (transf_c_program_match _ _ p'_compiles) (transf_c_program_match _ _ Cs_compiles)) as [Wbt_compiled [Wbt_compiles ?]].
    ...
    assert (W_W': match_prog W W').
    { destruct (@transf_link _ _ _ _ _ (pass_match_link (compose_passes CompCert's_passes))
                p Cs p_compiled Cs_compiled W link_p_Cs
                (transf_c_program_match _ _ p_p_compiled) (transf_c_program_match _ _ Cs_compiles)) as [W'' [R G]].
