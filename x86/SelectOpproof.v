...
- set (im := Int.repr Int.half_modulus).
  ...
  assert (eval_expr ge sp e cp m (Vfloat fm :: Vfloat f :: le) (Eletvar (S O)) (Vfloat f)).
    constructor. auto.
  assert (eval_expr ge sp e cp m (Vfloat fm :: Vfloat f :: le) (Eletvar O) (Vfloat fm)).
    constructor. auto.
  econstructor. eauto.
...
+ econstructor. eauto.
  ...
  assert (eval_expr ge sp e cp m (Vint i :: le) (Eletvar O) (Vint i)).
    constructor. auto.
...
Proof.
  ...
  assert (D: forall a,
             eval_expr ge sp e cp m le a v ->
             v = Vptr b ofs ->
             exists vl, eval_exprlist ge sp e cp m le (a ::: Enil) vl
...
Theorem eval_builtin_arg_addr:
  forall addr al vl v,
  eval_exprlist ge sp e cp m nil al vl ->
  Op.eval_addressing ge sp addr vl = Some v ->
  CminorSel.eval_builtin_arg ge sp e cp m (builtin_arg_addr addr al) v.
Proof.
