...
(* ALG: the initial memory state comes with some initialisation by
linker and preprocessing, and has dependencies beyond the memory model
interface *)
(* Parameter empty: ptrofs -> ptrofs -> PMap.t occap -> mem. *)
