...
Definition encode_val (chunk: cap_memory_chunk) (v: ocval) : list memval :=
  ...
  | OCVcap c, CMcap128 => if Archi.ptr64 then inj_value Q128 v else list_repeat 16%nat Undef
...
Ltac solve_decode_encode_val_general :=
  ...
  | |- OCVint (Int.sign_ext _ (Int.sign_ext _ _)) = OCVint _ => f_equal; apply Int.sign_ext_idem; omega
  | |- OCVint (Int.zero_ext _ (Int.zero_ext _ _)) = OCVint _ => f_equal; apply Int.zero_ext_idem; omega
  | |- OCVint (Int.sign_ext _ (Int.zero_ext _ _)) = OCVint _ => f_equal; apply Int.sign_ext_zero_ext; omega
  end.
