...
COMMON=Errors.v AST.v Linking.v \
  ...
  Exec.v Separation.v Builtins0.v Builtins1.v Builtins.v
...
SECURITY=RSC.v Split.v Blame.v Recomposition.v Tactics.v MemoryWeak.v MemoryDelta.v BtBasics.v BtInfoAsm.v Backtranslation.v BacktranslationAux.v BacktranslationProof.v
